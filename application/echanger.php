...
<link href="<?php echo site_url('/assets/fontawesome-free-6.2.1-web/css/all.min.css'); ?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url('/assets/css/search.css'); ?>" rel="stylesheet" type="text/css"/>
